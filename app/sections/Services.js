...
function ServiceBox({ title, price, description, features }) {
  return (
    <div className="md:w-[40%] lg:w-[367px] glassmorphism rounded-[5px]">
      <div className={`${styles.gradeint} px-10 py-6 space-y-2 h-[35%]`}>
      ...
      <div className="p-4 space-y-[20px]">
        {features.map((feature, index) => (
          <div className="flex gap-2" key={index}>
            ...
            />
            <p className="IBMPlexSans xl:text-[18px] leading-[27px]">
              {feature.feature}
            </p>
          </div>
        ))}
...
export default function Services() {
  return (
    <section id="pricing" className="sectionGap sectionPadding relative">
      ...
      <div className="w-full flex flex-wrap xl:flex-nowrap justify-center gap-10 mt-10">
